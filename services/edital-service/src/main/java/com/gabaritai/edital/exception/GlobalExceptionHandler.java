...
/** RNF-122: mensagens compreensiveis ao usuario, sem detalhes tecnicos. */
@RestControllerAdvice
public class GlobalExceptionHandler {

    private static final Logger log = LoggerFactory.getLogger(GlobalExceptionHandler.class);

    @ExceptionHandler(EditalDomainException.class)
    public ProblemDetail handleEditalDomainException(EditalDomainException ex) {
